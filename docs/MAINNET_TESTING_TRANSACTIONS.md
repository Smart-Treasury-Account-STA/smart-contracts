...
| 16 | `intent_registry.set_executor` — rotated the default treasury's relayer/executor from the deployment key to the dApp's real relayer address, called directly (not through a `smart_account` entrypoint — none exists for this), authorized by an Entry A/Entry B `AuthPayload` rooted at `intent_registry.set_executor` itself, signed only by `mainnet-deployer` (§12.7 of `docs/DAPP_INTEGRATION_SPEC.md`) | executor changed from `GAHNF7XS…` to `GCCPEHVEREZWAZ4W63HZLBLAO2IKNLDXX5NZNYXIWH4ZNBY7KZOULIN6` | `1b0886174d1271fb10e1af8d8e5e2e84879eeb1a38444c3d223867b95555b5ea` | [view](https://stellar.expert/explorer/public/tx/1b0886174d1271fb10e1af8d8e5e2e84879eeb1a38444c3d223867b95555b5ea) |
